...
public:
	simple_initiator_socket<switch_pcie> i_socket_0;
	simple_initiator_socket<switch_pcie> i_socket_1;
	simple_initiator_socket<switch_pcie> i_socket_2;
...
//	tlm_sync_enum nb_transport_bw( int index, tlm_generic_payload& transaction, tlm_phase& phase, sc_time& time);
	tlm_sync_enum nb_transport_bw_0(tlm_generic_payload& transaction, tlm_phase& phase, sc_time& time);
	tlm_sync_enum nb_transport_bw_1(tlm_generic_payload& transaction, tlm_phase& phase, sc_time& time);
	tlm_sync_enum nb_transport_bw_2(tlm_generic_payload& transaction, tlm_phase& phase, sc_time& time);
...
public:
	...
	:sc_module(name_), n_ports(n_ports_), n_vc(n_vc_)\
	 ,i_socket_0("i0"), i_socket_1("i1"), i_socket_2("i2"){
...
//			i_socket_2 = new simple_initiator_socket_tagged<switch_pcie>("hello");
			...
			i_socket_0.register_nb_transport_bw(this, &switch_pcie::nb_transport_bw_0);
			i_socket_1.register_nb_transport_bw(this, &switch_pcie::nb_transport_bw_1);
			i_socket_2.register_nb_transport_bw(this, &switch_pcie::nb_transport_bw_2);
		//}

//		i_socket.register_nb_transport_bw(this, &switch_pcie::nb_transport_bw,4);
		SC_THREAD(npu_process_0);
		SC_THREAD(npu_process_1);
		SC_THREAD(npu_process_2);
	}
};
